 ...
 fullPage::pageContainer(
  ...
  tags$ul(
    tags$li(tags$a(href="https://datenguidepy.readthedocs.io/en/latest/readme/", code("datenguidepy")), 
            ...
            "that collects, checks and verifies the data."), br(),
